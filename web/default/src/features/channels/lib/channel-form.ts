...
export const channelFormSchema = z.object({
  ...
  disable_http2: z.boolean().optional(),
  disable_connection_reuse: z.boolean().optional(),
  ...
  proxy_pool_retry_status_codes: z
    .string()
    .optional()
    .refine(validateStatusCodeList, {
      message: 'Status codes must be HTTP codes from 100 to 599',
    }),
  ...
  if (channel.setting) {
    try {
      ...
      extraSettings = {
        ...
        disable_http2: parsed.disable_http2 || false,
        disable_connection_reuse: parsed.disable_connection_reuse || false,
...
function buildSettingJSON(formData: ChannelFormValues): string {
  const settingObj = {
    ...
    disable_http2: formData.disable_http2 || false,
    disable_connection_reuse: formData.disable_connection_reuse || false,
...
function parseStatusCodeList(value: unknown): number[] {
...
function validateStatusCodeList(value: unknown): boolean {
