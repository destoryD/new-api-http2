...
type Channel struct {
	...
	DisableUsedQuota   *bool   `json:"disable_used_quota" gorm:"default:false"`
...
func updateChannelUsedQuota(id int, quota int) {
	err := DB.Model(&Channel{}).
		Where("id = ? AND (disable_used_quota = ? OR disable_used_quota IS NULL)", id, false).
